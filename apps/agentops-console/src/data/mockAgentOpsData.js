...
export const consoleData = {
  ...
  credentialHandoff: {
    ...
    sessions: [
      { id: "credential_handoff_boot_inst_fixture", schema_version: "agentops_credential_status.v1", bootstrap_id: "boot-inst-fixture", bootstrap_status: "credential_issued", credential_status: "active", credential_id: "cred-inst-fixture", token_id: "已隐藏", device_key_id: "store-device-key-1", installation_id: "inst-fixture", device_id: "device-fixture", expires_at: "2026-05-07T15:00:00Z", next_action: "send_signature_test_event", signature_test_event_id: "待接收", revocation_id: "未撤销", revoked_at: "未撤销", revocation_reason: "未撤销", revocation_scope: "未撤销", revocation_resolution: "未重新签发", reissue_id: "未重新签发", reissued_at: "未重新签发", reissued_by: "未重新签发", reissued_bootstrap_id: "未重新签发", reissued_credential_id: "未重新签发", agentops_fact_owner: "agentops", agent_store_consumer_boundary: "display_only_no_active_inference", allowed_actions: "display_status,show_next_action", forbidden_actions: "infer_active,issue_credential,issue_ingestion_token,issue_device_key", verified_loaded: "not_asserted", l5_status: "not_asserted", display_scope: "只读回显，不包含 token 值、token_id 明文、私钥或原始载荷。" },
      { id: "credential_handoff_boot_inst_verified", schema_version: "agentops_credential_status.v1", bootstrap_id: "boot-inst-verified", bootstrap_status: "signature_verified", credential_status: "active", credential_id: "cred-inst-verified", token_id: "已隐藏", device_key_id: "store-device-key-2", installation_id: "inst-verified", device_id: "device-verified", expires_at: "2026-05-07T15:00:00Z", next_action: "display_activation_result", signature_test_event_id: "evt_signature_test_verified", revocation_id: "未撤销", revoked_at: "未撤销", revocation_reason: "未撤销", revocation_scope: "未撤销", revocation_resolution: "未重新签发", reissue_id: "未重新签发", reissued_at: "未重新签发", reissued_by: "未重新签发", reissued_bootstrap_id: "未重新签发", reissued_credential_id: "未重新签发", agentops_fact_owner: "agentops", agent_store_consumer_boundary: "display_only_no_active_inference", allowed_actions: "display_status,show_next_action", forbidden_actions: "infer_active,issue_credential,issue_ingestion_token,issue_device_key", verified_loaded: "not_asserted", l5_status: "not_asserted", display_scope: "只读回显，不包含 token 值、token_id 明文、私钥或原始载荷。" },
      { id: "credential_handoff_boot_inst_revoked", schema_version: "agentops_credential_status.v1", bootstrap_id: "boot-inst-revoked", bootstrap_status: "revoked", credential_status: "revoked", credential_id: "cred-inst-revoked", token_id: "已隐藏", device_key_id: "store-device-key-3", installation_id: "inst-revoked", device_id: "device-revoked", expires_at: "2026-05-07T15:00:00Z", next_action: "reissue_credential", signature_test_event_id: "evt_signature_test_revoked", revocation_id: "revoke-inst-revoked", revoked_at: "2026-05-07T15:10:00Z", revocation_reason: "设备遗失", revocation_scope: "credential_and_device_key", revocation_resolution: "reissued", reissue_id: "reissue-inst-revoked", reissued_at: "2026-05-07T15:14:00Z", reissued_by: "security-operator", reissued_bootstrap_id: "boot-inst-revoked-r1", reissued_credential_id: "cred-inst-revoked-r1", agentops_fact_owner: "agentops", agent_store_consumer_boundary: "display_only_no_active_inference", allowed_actions: "display_status,show_next_action", forbidden_actions: "infer_active,issue_credential,issue_ingestion_token,issue_device_key", verified_loaded: "not_asserted", l5_status: "not_asserted", display_scope: "只读回显，不包含 token 值、token_id 明文、私钥或原始载荷。" }
    ],
    guardrails: [
