...
CONTRACT_REGISTRY: dict[str, ContractRegistryEntry] = {
    ...
    "quality_scorer_external_intake_index.v1": _entry(
        "quality_scorer_external_intake_index.v1",
        domain_owner="AgentOps",
        producer="AgentOps",
        consumers=("Ops", "Ai_AutoSDLC"),
        ...
        optional_fields=("producer", "received_at", "accepted_execution_id"),
        enum_fields={
            "method": ("GET",),
    ...
    "quality_scorer_external_intake_summary.v1": _entry(
        "quality_scorer_external_intake_summary.v1",
        domain_owner="AgentOps",
        producer="AgentOps",
        consumers=("Ops", "Ai_AutoSDLC"),
        ...
        enum_fields={
            "method": ("GET",),
            "status_code": ("200", "400", "401", "403"),
            "health_state": ("no_receipts", "receiving", "needs_review"),
        },
        state_registry_refs=("degraded", "blocked"),
        error_codes=(
    ...
    "quality_center_external_intake_health.v1": _entry(
        "quality_center_external_intake_health.v1",
        domain_owner="AgentOps",
        producer="AgentOps",
        consumers=("Ops", "Ai_AutoSDLC"),
        ...
        state_registry_refs=("degraded", "blocked"),
        error_codes=("QUALITY_CENTER_WORKBENCH_UNAVAILABLE",),
        contract_tests=("AO50-CT-001", "AO50-CT-002", "AO50-CT-003"),
        compatibility_policy="p1_backward_compatible",
    ),
    "quality_center_external_intake_portfolio.v1": _entry(
        ...
        optional_fields=("generated_from",),
        enum_fields={
            "portfolio_state": (
                "empty",
                "no_receipts",
    ...
    "quality_center_external_intake_portfolio_http.v1": _entry(
...
ERROR_CODE_REGISTRY: dict[str, ErrorCodeDefinition] = {
    ...
    "QUALITY_SCORER_INTAKE_INDEX_QUERY_REQUIRED": ErrorCodeDefinition(
        "QUALITY_SCORER_INTAKE_INDEX_QUERY_REQUIRED",
        400,
        False,
        "外部质量评分器接入索引查询缺少必要条件。",
        "External quality scorer intake index query requires full scope.",
        False,
    ),
    "QUALITY_SCORER_INTAKE_INDEX_LIMIT_INVALID": ErrorCodeDefinition(
        "QUALITY_SCORER_INTAKE_INDEX_LIMIT_INVALID",
        400,
        False,
        "外部质量评分器接入索引 limit 无效。",
        "External quality scorer intake index limit is invalid.",
        False,
    ),
    "QUALITY_SCORER_INTAKE_SUMMARY_QUERY_REQUIRED": ErrorCodeDefinition(
        "QUALITY_SCORER_INTAKE_SUMMARY_QUERY_REQUIRED",
        400,
        False,
        "外部质量评分器接入摘要查询缺少必要条件。",
        "External quality scorer intake summary query requires full scope.",
        False,
    ),
    "QUALITY_SCORER_INTAKE_SUMMARY_LIMIT_INVALID": ErrorCodeDefinition(
        "QUALITY_SCORER_INTAKE_SUMMARY_LIMIT_INVALID",
        400,
        False,
        "外部质量评分器接入摘要 limit 无效。",
        "External quality scorer intake summary limit is invalid.",
        False,
    ),
    "QUALITY_CENTER_INTAKE_PORTFOLIO_SCOPE_REQUIRED": ErrorCodeDefinition(
        "QUALITY_CENTER_INTAKE_PORTFOLIO_SCOPE_REQUIRED",
        400,
        False,
        "Quality Center external intake portfolio 查询缺少 scope。",
        "Quality Center external intake portfolio query requires at least one scope.",
        False,
    ),
    "QUALITY_CENTER_INTAKE_PORTFOLIO_SCOPE_INVALID": ErrorCodeDefinition(
        "QUALITY_CENTER_INTAKE_PORTFOLIO_SCOPE_INVALID",
        400,
        False,
        "Quality Center external intake portfolio scope 格式无效。",
        "Quality Center external intake portfolio scope format is invalid.",
        False,
    ),
    "QUALITY_CENTER_INTAKE_PORTFOLIO_LIMIT_INVALID": ErrorCodeDefinition(
        "QUALITY_CENTER_INTAKE_PORTFOLIO_LIMIT_INVALID",
        400,
        False,
        "Quality Center external intake portfolio limit 无效。",
        "Quality Center external intake portfolio limit is invalid.",
        False,
    ),
