...
def create_app() -> dict[str, str]:
    return {
        ...
        "runtime_sdlc_run_health_summary": "GET /v1/runtime/sdlc/runs/{run_id}/health-summary",
        "runtime_sdlc_findings": "GET /v1/runtime/sdlc/findings",
        "runtime_sdlc_trends": "GET /v1/runtime/sdlc/trends",
