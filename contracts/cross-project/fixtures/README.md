...
- `ai_sdlc_executable_task_runtime_batch.v1.json` is produced by Ai_AutoSDLC v0.7.18+ and consumed by AgentOps Runtime Ingestion. It demonstrates executable task and task guard facts sent through `runtime.ingestion.v1`.
...
- `ai_sdlc_executable_task_runtime_batch.v1.json`: `139a38707e22bacbdc57b5171961f2a5baa6a44498efd3e802652439449ff350`
