...
def payload_for(event_type: str):
    payloads = {
        ...
        "executable_task_prepared": {
            "run_id": "run_1",
            "workitem": "WI-1",
            "executable_task_id": "T1",
            "task_title": "Implement scoped change",
            "task_guard_state": "allowed",
            "adapter_diagnostic_state": "degraded",
            "evidence_ref": "vault://sdlc/run_1/task",
        },
        "code_change_guard_result": {
            ...
            "blocking_reason": "",
            "evidence_ref": "vault://sdlc/run_1/guard",
        },
        "gate_result": {
            "gate_id": "gate_refine",
            "gate_name": "refine",
